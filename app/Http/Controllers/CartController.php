...
class CartController extends Controller
{
    ...
    public function getCart(Request $request)
    {
        ...
        foreach ($cartItems as $cartItem) {
            ...
            $stockLevel = 0;
            $stockStatus = 'outofstock'; // Default to 'outofstock'
            if ($variation) {
            ...
            // Determine stock status based on meta value (e.g., 'instock' or 'outofstock')
            ...
            $cartData[] = [
                ...
                'variation' => $variation ? $variation->meta : null,
            ];
        }
